<template>
  <div>
    <el-tabs v-model="searchForm.tab" @tab-change="getData">
      <el-tab-pane :label="item.name" :name="item.key" v-for="(item, index) in tabbars" :kye="index"></el-tab-pane>
    </el-tabs>
    ...
    <el-card shadow="never" class="border-0">
      ...
      <el-table ref="multiSelectionIds" @selection-change="handleSelectionChange" :data="tableData" stripe
        ...
        <el-table-column label="实际销量" width="70" prop="sale_count" align="center"></el-table-column>
      ...
      <FormDrawer ref="formDrawerRef" :title="drawerTitle" @submit="handleSubmit">
        <el-form :model="form" ref="formRef" label-width="80px" :inline="false">
          ...
          <el-form-item label="商品描述" prop="desc">
            <el-input v-model="form.desc" placeholder="选填, 商品卖点"></el-input>
          </el-form-item>
